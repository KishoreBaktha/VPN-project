...
public class ForwardServerClientThread extends Thread {
    ...
    private int ServerOrClient; // 1 for server, 2 for client
     ...
     */
    public ForwardServerClientThread(Socket aClientSocket, String serverhost, int serverport, SessionDecrypter sessionDecrypter, SessionEncrypter sessionEncrypter) {
